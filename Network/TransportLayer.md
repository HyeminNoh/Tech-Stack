...
<img src="./resources/3-way-handshake.jpeg" height="300px">
...
<img src="./resources/3-way-handshake.jpeg" height="370px">
...
<img src="./resources/flow_control" height="400px">
...
그렇게 되면 호스트들은 또 다시 재전송을 하게 되고 혼잡을 가중시켜 오버플로우나 데이터 손실을 발생시킨다.
따라서, 이러한 네트워크의 혼잡을 피하기 위해 송신측에서 보내는 데이터의 전송 속도를 강제로 줄이게 되는데, 이러한 작업을 `혼잡제어`라고 한다.  
